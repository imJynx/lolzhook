...
namespace MyConfigSaver {
    void SaveConfig(const std::string& filename) {
        std::ofstream configFile(MenuConfig::ConfigPath + '\\' + filename);
        ...
        configFile.close();
        std::cout << "[Info] Configuration saved to " << MenuConfig::ConfigPath + '\\' + filename << std::endl;
    }
    ...
    void LoadConfig(const std::string& filename) {
        ...
        configFile.close();
        std::cout << "[Info] Configuration loaded from " << MenuConfig::ConfigPath + '\\' + filename << std::endl;
    }
